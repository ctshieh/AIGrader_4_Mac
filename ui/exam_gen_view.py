# ui/exam_gen_view.py
# -*- coding: utf-8 -*-
# Module-Version: v2026.01.23-Features-Restored
# Description: 
# 1. [Restore] 恢復「手動編譯 (Manual Compile)」功能，允許使用者修改 LaTeX 後預覽。
# 2. [Restore] 保留所有進階排版 (Compact Header / Layout Mode)。
# 3. [Merged] 整合 AI 智慧命題與資料正規化。
